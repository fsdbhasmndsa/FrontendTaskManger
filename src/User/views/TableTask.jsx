            ...
            <div className="modal-body row" style={{ minHeight: 300 }}>
              <div className="col-md-12">
                <form onSubmit={Formik.handleSubmit} >
                  ...
                  {StatusUpdate ? <button type='submit' className='btn fw-bold text-light mt-4' disabled={loading} style={{ background: `linear-gradient(135deg, #ff6a6a, #d63031)`, minWidth: 100 }}> {loading ? "Đang cập nhật..." : "Cập nhật"}</button>
                    :
                    <button type='submit' className='btn fw-bold text-light mt-4' disabled={loading} style={{ background: `linear-gradient(135deg, #00c6ff, #0072ff)`, minWidth: 100 }}> {loading ? "Đang thêm..." : "Thêm"}</button>}
